...
<body>
	...
	<div class="main">
		<div style="text-align: justify;">
			...
			<form method="post"
				action="clubBudgetTotal.do?club_id=<%=club_id%>"
				...
				<input type="submit" name="submit" value="조회" class="search-btn"/>
			</form>
			...
			<table class="total-tbl" style="margin-right: 30px;">
				...
				<%
					ArrayList<BudgetVO> budget_list = (ArrayList<BudgetVO>) session.getAttribute("incomeList");
			...
			<table class="total-tbl">
				...
				<%
					budget_list = (ArrayList<BudgetVO>) session.getAttribute("expenseList");
			...
			<%
				int in_total = 0;
				int out_total = 0;
				String incomeTotalPrice = (String) session.getAttribute("incomeTotalPrice");
				String expenseTotalPrice = (String) session.getAttribute("expenseTotalPrice");
				if(! (incomeTotalPrice==null || incomeTotalPrice.trim().equals("")))
					in_total = Integer.parseInt(incomeTotalPrice);
				
				if(! (expenseTotalPrice==null || expenseTotalPrice.trim().equals("")))
					out_total = Integer.parseInt(expenseTotalPrice);
			%>
