...
<html>
<head>
    <title>${clubVO.club_nm} 소개 - 수정 </title>
                ...
                <div class="content" id="jwxe_main_content">
                    ...
                    <div class="ko board write co-board type01">
	                    <div class="bn-write-common01 type01">
	                        ...
	                        <form method="post" action="/clubIntroUpdateAction.do" name="boardForm" enctype="multipart/form-data">
	                            <fieldset>
				                    <legend class="hide">${clubVO.club_nm} 소개</legend>
