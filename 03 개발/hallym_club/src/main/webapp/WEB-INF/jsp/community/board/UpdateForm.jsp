...
<head>
	...
	<script type="text/javascript">
		function ListForm(){
		    location.href="/clubBoardList.do";
		}
        ...
        <div class="sub-container newclub">
			...
			<c:choose>
				<c:when test='${board_cd eq "007001" || board_cd eq "007002"}'>
					<jsp:include page="/WEB-INF/jsp/community/board/item/BoardUpdateContents.jsp"/>
				</c:when>
				<c:when test='${board_cd eq "007003"}'>
					<jsp:include page="/WEB-INF/jsp/community/board/item/GalleryUpdateContents.jsp"/>
				</c:when>
				<c:when test='${board_cd eq "007004"}'>
					<jsp:include page="/WEB-INF/jsp/community/board/item/CalendarUpdateContents.jsp"/>
				</c:when>
				<c:otherwise>
