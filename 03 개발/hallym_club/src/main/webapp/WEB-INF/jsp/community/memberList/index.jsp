	...
	<div class="sub-wrap">
		...
		<!--공지사항 보기-->
            <div class="sub-container newclub">
                ...
                <!--본문-->
                <h1><i class="fas fa-user"></i>회원목록</h1>
					...
					<div class="ko board list co-board type01">
						<div class="common">
							...
							<div class="bn-search01 type01">
								<form method="post" action="/clubMemberList.do" name="boardForm" enctype="multipart/form-data">
									<fieldset class="b-search-wrap">
										...
										<div class="b-sel-box b-cate-basic league" style="z-index: 0;">
											<select class="b-sel-title leagueform ver2" name="select">
                                                ...
                                                <option class="searchOption" value="3">전공</option>
											</select>
											<label for="search_val" class="b-sel-label"><span>검색어</span></label>
											<input type="text" id="person_val" name="cdn" value="${cdn}" placeholder="검색어를 입력해 주세요">
								...
								<table summary="게시판 > Notice" class="board-table">
									...
									<thead>
										<tr>
											...
											<th scope="col" class="hver2">전공</th>
											<th scope="col" class="hver2">직위</th>
										</tr>
									</thead>
									<tbody>
										<!-- 글 없을때
									...
									<c:when test="${not empty memberList}">
											...
											<td class="b-td-left leagueKind">
												...
												<div class="b-title-box league">
													<!--반응형 모바일 부분-->
														...
														<div class="b-m-con">
															<span class="b-writer">학번:${item.student_id}</span>
                                                            <span class="b-writer">전공:${item.major}</span>
                                                            <span class="b-writer">직위: ${item.staff_cd}</span>           
														</div>
													</div>
												</td>
												<td>${item.getMajor()}</td>
										...
										<c:otherwise>
											<td class="b-no-post" colspan="4">등록된 회원이 없습니다.</td>
										</c:otherwise>
									</c:choose> 
									</tbody>
								</table>          
