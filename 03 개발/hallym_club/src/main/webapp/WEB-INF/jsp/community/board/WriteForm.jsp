        ...
        <div class="sub-container newclub">
			...
			<c:choose>
				<c:when test='${board_cd eq "007001" || board_cd eq "007002"}'>
					<jsp:include page="/WEB-INF/jsp/community/board/item/BoardWriteContents.jsp"/>
				</c:when>
				<c:when test='${board_cd eq "007003"}'>
					<jsp:include page="/WEB-INF/jsp/community/board/item/GalleryWriteContents.jsp"/>
				</c:when>
				<c:when test='${board_cd eq "007004"}'>
					<jsp:include page="/WEB-INF/jsp/community/board/item/CalendarWriteContents.jsp"/>
				</c:when>
				<c:otherwise>
