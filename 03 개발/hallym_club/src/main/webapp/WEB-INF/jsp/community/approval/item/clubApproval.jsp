...
<script type="text/javascript">
	function ListForm(data1){
		location.href="/clubApprovalList.do?club_id=" + data1;
    }
</script>
</head>
	...
	<div class="sub-wrap">
		...
		<!--공지사항 보기-->
            <div class="sub-container newclub">
                <!--본문-->
            	<h1><i class="fas fa-user-cog"></i>회원 승인</h1>
                ...
                <div class="content" id="jwxe_main_content_clubModify">
					...
					<div class="ko board write co-board type01">
						<div class="bn-write-common01 type01">
							...
							<form name="writeForm2" method="post" action="/">
								<fieldset>
									...
									<div class="b-table-wrap">
										...
										<div class="b-table-box type01 b-subject-box">
											<div class="b-row-box">
                                                ...
                                                <div class="b-con-box ver2">
													<input class="jwvalid-must-title b-input ver2 type01" type="text" id="clubStd" name="clubStd" value="${memberInfo.major}" disabled>
												</div>
                                                <!--학년-->
												<div class="b-title-box ver2 b-required">
												...
												<div class="b-con-box ver2">
													<input class="jwvalid-must-title b-input ver2 type01" type="text" id="clubstdYear" name="clubstdYear" value="${memberInfo.grade}" disabled>
												</div>
											</div>
										</div>
										<!--학번, 이름-->
										<div class="b-table-box type01 b-notice-box">
											<div class="b-row-box">
												...
												<div class="b-con-box ver2">
													<input class="jwvalid-must-title b-input ver2 type01" type="text" id="clubstdNum" name="clubstdNum" value="${memberInfo.student_id}" disabled>
												</div>
												<div class="b-title-box ver2 b-required">
													<label for="clubName">성명</label>
												</div>
												<div class="b-con-box ver2">
													<input class="jwvalid-must-title b-input ver2 type01" type="text" id="clubName" name="clubName" value="${memberInfo.name}" disabled>
                                                </div>
											</div>
										</div>
                                        ...
                                        <div class="b-table-box type01 b-notice-box">
											<div class="b-row-box">
												...
												<div class="b-con-box ver2">
													<input class="jwvalid-must-title b-input ver2 type01" type="text" id="clubtel" name="clubtel" value="${memberInfo.phone_no}" disabled>
												</div>
												<div class="b-title-box ver2">
													<label for="clubemail"></label>이메일</label>
												</div>
												<div class="b-con-box ver2">
													<input class="jwvalid-must-title b-input ver2 type01" type="text" id="clubemail" name="clubemail" value="${memberInfo.email}" disabled>
												</div>
											</div>
										</div>
								...
								<div class="b-btn-wrap">
									<a class="b-btn-type01 b-btn-c-white ver2" title="취소" href="javascript:ListForm('${club_id}');">목록</a>
                                </div>	     
							</form>
						</div>
					</div>
