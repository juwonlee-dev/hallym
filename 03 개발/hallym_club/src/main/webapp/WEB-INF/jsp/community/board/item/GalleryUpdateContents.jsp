		                        	...
		                        	<div class="b-con-box02 ver2">
										...
										<div class="b-file-box type04">
											<div class="attach-data">
												<div>
													<p>
													<input class="attch-del-check b-chk ver2" type="checkbox" id="${thumbnailFile.file_no}" name="deleteThumbnail" value="${thumbnailFile.file_no}">
								                    <label for="${thumbnailFile.file_no}" class="del">${thumbnailFile.file_nm}</label>
													</p>
								                    <label class="txt-btn sm on" for="${thumbnailFile.file_no}"><span class="b-file-del-btn ver2">삭제</span></label>
												</div>
											</div>
										</div>
										</c:if>
										<div class="b-file-box type03">
											<div>
												<div>										
			                                    <input data-valid-title="썸네일" type="text" id="file_view0" name="wr-file-name" class="b-input jwvalid-imgfile img-check ver2" placeholder="썸네일을 등록하세요" readonly="">
			                                    ...
			                                    <label for="file_nm0" class="b-file-btn ver2">찾아보기</label>
												</div>
			                                </div>
			                            </div>
						        	</div>
