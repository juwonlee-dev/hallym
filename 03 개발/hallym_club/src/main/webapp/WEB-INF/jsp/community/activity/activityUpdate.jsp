...
<body id="item_body" class="pc">
	...
	<div class="sub-wrap">
					...
					<ul>
						...
						<c:choose>
							<c:when test="${act_cd eq '015001'}">
								<li class="clubonly">교내 활동 수정</li>
							</c:when>
							<c:when test="${act_cd eq '015002'}">
								<li class="clubonly">교외 활동 수정</li>
							</c:when>
						</c:choose>
					</ul>
				</div>
		...
		<div class="sub-container newclub">
			...
			<c:choose>
				<c:when test="${act_cd eq '015001'}">
					<h1><i class="fas fa-user-check"></i>교내 활동 수정</h1>
				</c:when>
				<c:when test="${act_cd eq '015002'}">
					<h1><i class="fas fa-user-check"></i>교외 활동 수정</h1>
				</c:when>
			</c:choose>
					...
					<div class="ko board write co-board type01">
						<div class="bn-write-common01 type01">
							...
							<form name="writeForm" method="post"
								action="/clubActivityUpdateAction.do"
									...
									<div class="b-table-wrap">
											...
											<div class="b-row-box">
												...
												<div class="b-con-box ver2">
													<input class="jwvalid-must-title b-input ver2 type01"
														name="act_date" title="시작 날짜" id="clubStart" type="text"
														maxlength="10" readonly="readonly" value="${activityVO.act_date}"
														data-valid-title="공지시작일" style="width: 100%;">
												</div>
											</div>
										</div>
										<!--활동명-->
										...
										<div class="b-table-box type01 b-notice-box">
											<div class="b-row-box">
												...
												<div class="b-con-box ver2">
													<input class="jwvalid-must-title b-input ver2 type01"
														type="text" id="clubPerson" name="act_cnt" value="${activityVO.act_cnt}"
														required>
												</div>
											</div>
										</div>
											...
											<div class="b-row-box">
												...
												<div class="b-con-box ver2">
													<textarea class="textareaBox ver2 modify"
														name="act_contents" required>${activityVO.act_contents}</textarea>
												</div>
											</div>
										</div>
										...
										<div class="b-table-box type01 b-subject-box">
											...
											<div class="b-row-box">
												...
												<div class="b-con-box ver2">
													<textarea class="textareaBox ver2 modify" name="act_temp"
														required>${activityVO.act_temp}</textarea>
												</div>
											</div>
										</div>
										<!--증빙 자료-->
												...
												<div class="b-con-box02 ver2">
													...
													<div class="b-file-box type04">
														...
														<div class="attach-data">
															<div>
																<p>
																	<input class="attch-del-check b-chk ver2"
																		type="checkbox" id="${item.file_no}" name="deleteAttach" value="${item.file_no}">
																	<label for="${item.file_no}" class="del">${item.file_nm}</label>
																</p>
																<label class="txt-btn sm on" for="${item.file_no}"><span
																	class="b-file-del-btn ver2">삭제</span></label>
															</div>
															<!-- 
                                                          <div class="b-guide-box">
                                                              <input type="hidden" name="editAttachjavax.servlet.jsp.jstl.core.LoopTagSupport$1Status@268555fc" value="1">
                                                              <label class="b-guide-txt hide" for="editAltjavax.servlet.jsp.jstl.core.LoopTagSupport$1Status@268555fc">대체 텍스트 </label> 
                                                              <input data-valid-title="대체텍스트" class="b-input file-alt" type="text" id="editAltjavax.servlet.jsp.jstl.core.LoopTagSupport$1Status@268555fc" name="editAltjavax.servlet.jsp.jstl.core.LoopTagSupport$1Status@268555fc" value="" placeholder="대체텍스트를 입력해주세요.">
                                                          </div>
                                                           -->
														</div>
														</c:forEach>
													...
													<c:forEach var="fnum" begin="1" end="10">
														<div class="b-file-box type03 file-list"
															...
															<div>
																<div>
																	<input type="text" id="file_view${fnum}"
																		name="wr-file-name" class="b-input"
																		placeholder="첨부파일을 등록하세요" readonly="">
																	<!--  name="wr-file-name" -->
																	<input class="outTable thumb hide  " type="file"
																		id="file_nm${fnum}" name="attachFile"
																		onchange="javascript:document.getElementById('file_view${fnum}').value = this.value;">
