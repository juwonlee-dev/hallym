...
<head>
    ...
    <!--fullcalendar-->
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/res/board/css/fullcalendar.css">
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/res/board/css/fullcalendar2.css">
    <script type="text/javascript" src="${pageContext.request.contextPath}/res/board/js/fullcalendar.js" defer></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/res/board/js/fullcalendar2.js" defer></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/res/board/js/fullcalendar3.js" defer></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/res/board/js/ko.js" defer></script>
...
<body id="item_body" class="pc">
        ...
        <div class="sub-container newclub">
			...
			<c:choose>
				<c:when test='${board_cd eq "007001" || board_cd eq "007002"}'>
					<jsp:include page="/WEB-INF/jsp/community/board/item/BoardListContents.jsp" />
				</c:when>
				<c:when test='${board_cd eq "007003"}'>
					<jsp:include page="/WEB-INF/jsp/community/board/item/GalleryListContents.jsp" />
				</c:when>
				<c:when test='${board_cd eq "007004"}'>
					<jsp:include page="/WEB-INF/jsp/community/board/item/CalendarListContents.jsp" />
				</c:when>
				<c:otherwise>
	...
	<script type="text/javascript">	        
        ...
        function getPage(data1, data2, data3, data4, data5) {
        	...
        	var opt = data5;
        	var link = urlpaging + "page=" + page + "&club_id=" + club_id + "&opt=" + opt + "&bdc=" + bdc  
        	if(data3 != null){
        		link += "&cdn=" + cdn;
        	}
        	location.href = link; 
