						...
						<div class="b-table-wrap">
                            ...
                            <div class="b-table-box type01 b-notice-box">
                            	<div class="b-row-box">
                                    ...
                                    <div class="b-con-box ver2">
                                    <fmt:parseDate value="${start_date}" var="tmp" pattern="yyyy-MM-dd HH:mm:ss.SSS"/>
									<fmt:formatDate value="${tmp}" var="startDate" pattern="yyyy.MM.dd"/>
									<fmt:parseDate value="${end_date}" var="tmp" pattern="yyyy-MM-dd HH:mm:ss.SSS"/>
									<fmt:formatDate value="${tmp}" var="endDate" pattern="yyyy.MM.dd"/>
                                        <input name="start_date" title="시작 날짜" class="showdate ver2" id="leagueStart" type="text" maxlength="10" readonly="readonly" value="${startDate}" data-valid-title="일정시작일">
                                        ~
                                        <input name="end_date" title="종료 날짜" class="showdate ver2" id="leagueEnd" type="text" maxlength="10" readonly="readonly" value="${endDate}" data-valid-title="일정마감일">	
                                    </div>
                                </div>
                            </div>
