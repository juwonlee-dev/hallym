...
<head>
    ...
    <script type="text/javascript">
        function ListForm(){
            location.href="/BoardSearch.do?bdc=007001";
        }
                ...
                <div class="content" id="jwxe_main_content">
                    ...
                    <div class="ko board write co-board type01">
	                    <div class="bn-write-common01 type01">
	                        ...
	                        <form method="post" action="/BoardUpdateAction.do" name="boardForm" accept-charset="UTF-8"
	                        enctype="multipart/form-data"  onsubmit="return checkForm();">
	                            <fieldset>
	                                        ...
	                                        <div class="b-row-box">
	                                            <div class="b-title-box b-required">
	                                                ...
	                                                <% } else { %>
														제목
	                                                <%-- <c:choose>
														<c:when test="${board_cd eq '007207' or board_cd eq '007202'}">
															팀명
														</c:when>
														<c:otherwise>
															제목
	                                            ...
	                                            <div class="b-con-box">
	                                                <input class="jwvalid-must-title b-input type01" type="text" id="articleTitle" name="title" value="${searchBoard.title}" maxlength="120">
	                                            </div>
	                                        </div>
	                                    </div>
	                                    ...
	                                    <div class="b-table-box type01">
	                                        <div class="b-row-box">
	                                            ...
	                                            <div class="b-con-box">
	                                                ...
	                                                <input data-valid-title="작성자" class="jwvalid-must b-input type02" type="text" id="writerNm_view" name="writer_view" value=
	                                                <%
                           							if(isAdmin) {
						                          	%>
						                           		관리자(${writerName})
						                          	<%
						                           	...
						                           	%>
	                                                 disabled>
	                                                <input data-valid-title="수정자" class="hide hide2" type="text" id="writerNm" name="writer" value="<%=userId%>">
	                                            </div>
	                                        </div>
	                                    </div>
	                                    <%
						                    	...
						                    	<div class="b-title-box ">
						                       	...
						                       	<div class="b-con-box">
						                        	<div class="b-period-box">
						                            	<!-- <p> -->
						                               		<input type="checkbox" id="fix_yn" name="fix_yn" class="b-chk" value="Y" 
						           ...
						           %>
										...
										<%
		                           		String[] photoBoards = {"007002", "007003"};
	                            		if(Arrays.asList(photoBoards).contains(board_cd)) {
			                           	%>
										<!-- 썸네일 -->
										<div class="b-table-box type01">
											<div class="b-row-box">
					                        	...
					                        	<div class="b-con-box02">
													 <!-- 수정일경우 첨부 삭제 선택 -->
													<c:if test="${hasThumbnail eq true}">
													<div class="b-file-box type04">
														<div class="attach-data">
															<div>
																<p>
																<input class="attch-del-check b-chk" type="checkbox" id="${thumbnailFile.file_no}" name="deleteThumbnail" value="${thumbnailFile.file_no}">
											                    <label for="${thumbnailFile.file_no}" class="del">${thumbnailFile.file_nm}</label>
																</p>
											                    <label class="txt-btn sm on" for="${thumbnailFile.file_no}"><span class="b-file-del-btn">삭제</span></label>
															</div>
														</div>
													</div>
													</c:if>
													<div class="b-file-box type03">
														<div>
															<div>										
						                                    <input data-valid-title="썸네일" type="text" id="file_view0" name="wr-file-name" class="b-input jwvalid-imgfile img-check" placeholder="썸네일을 등록하세요" readonly="">
						                                    <input class="outTable hide thumb" type="file" id="file_nm0" name="thumbnailFile" onchange="javascript:document.getElementById('file_view0').value = this.value;">
						                                    <label for="file_nm0" class="b-file-btn">찾아보기</label>
															</div>
						                                </div>
						                            </div>
									        	</div>
