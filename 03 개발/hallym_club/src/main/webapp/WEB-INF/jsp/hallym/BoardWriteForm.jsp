...
<body id="item_body" class="pc" style="position: relative; min-height: 100%; top: 0px;">
	...
	<%
		...
		boolean isAdmin = Arrays.asList(allowAuth).contains(auth_code);
		System.err.println("[BoardWriteForm.jsp] auth_code: " +auth_code);
	%>
	<ul id="go_main">
                ...
                <div class="content" id="jwxe_main_content">
                    ...
                    <div class="ko board write co-board type01">
	                    <div class="bn-write-common01 type01">
	                        ...
	                        <form method="post" action="/BoardWriteAction.do" accept-charset="UTF-8"
	                        name="boardForm" enctype="multipart/form-data" onsubmit="return checkForm();">
	                            <fieldset>
						                   ...
						                   <div class="b-row-box">
						                       ...
						                       <div class="b-con-box">
						                           <div class="b-period-box">
						                               <p>
							                               <input type="checkbox" id="fix_yn" name="fix_yn" class="b-chk" value="Y">  <!-- wr-notice-name -->
	                                    ...
	                                    <div class="b-table-box type01">
	                                        <div class="b-row-box">
	                                            ...
	                                            <div class="b-con-box">
	                                                ...
	                                                <input data-valid-title="작성자명" class="jwvalid-must b-input type02" type="text" id="writerNm_view" name="writer_view" value=
	                                                <%
					                        		if(isAdmin) {
						                          	%>
						                          		관리자(<%=userName%>)
						                          	...
						                          	%>
	                                                disabled>
	                                                <input data-valid-title="작성자" class="hide hide2" type="text" id="writerNm" name="writer" value="<%=userId%>">
	                                            </div>
	                                        </div>
	                                    </div>
