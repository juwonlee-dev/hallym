...
(function () {
  ...
  Andwise.apply(Andwise, {
      ...
      Andwise.iterate(o, function (key, item) {
        ...
        Andwise.each(empty ? key : item, function (val) {
          buf.push(
            ...
            e(key),
            "=",
            !Andwise.isEmpty(val) && (val != key || !empty)
              ? Andwise.isDate(val)
                ? Andwise.encode(val).replace(/"/g, "")
                : e(val)
              : ""
          );
        });
    ...
    isIterable: function (v) {
      ...
      return (
        (typeof v.nextNode != "undefined" || v.item) &&
        Andwise.isNumber(v.length)
      );
    },
    ...
    removeNode:
      isIE && !isIE8
        ? (function () {
            ...
            return function (n) {
              if (n && n.tagName != "BODY") {
                Andwise.enableNestedListenerRemoval
                  ? Andwise.EventManager.purgeElement(n, true)
                  : Andwise.EventManager.removeAll(n);
  ...
  (v.defaults = {}),
    h(v.prototype, {
      spin: function (e) {
        ...
        var t = this,
          n = t.opts,
          r = (t.el = c(o(0, { className: n.className }), {
            position: n.position,
            width: 0,
            zIndex: n.zIndex,
          })),
        ...
        e &&
          ...
          c(r, {
            left:
              (n.left == "auto"
                ? a.x - u.x + (e.offsetWidth >> 1)
                : parseInt(n.left, 10) + i) + "px",
            top:
              (n.top == "auto"
                ? a.y - u.y + (e.offsetHeight >> 1)
                : parseInt(n.top, 10) + i) + "px",
          })),
            ...
            function l(t, i, o) {
              u(
                ...
                u(
                  ...
                  u(
                    c(e("roundrect", { arcsize: n.corners }), {
                      width: r,
                      height: n.width,
                      left: n.radius,
                      top: -n.width >> 1,
                    ...
                    e("fill", { color: n.color, opacity: n.opacity }),
                    e("stroke", { opacity: 0 })
                  )
                )
              );
...
function $m(code, defaultMsg) {
  ...
  if (
    !isLoadMessageScript &&
    typeof messageCode == "undefined" &&
    typeof localeScriptPath != "undefined"
  ) {
  ...
  if (!retv) {
    ...
    if (typeof locale !== "undefined") {
      ...
      retv =
        lngCode && lngCode.hasOwnProperty(code)
          ? lngCode[code]
          : cmsMsg.ko[code];
    }
...
$.browser.ismobile = /mobile|iphone|ipad|ipod|android|blackberry|symbian|mobi|polaris|iemobile|lgtelecom|nokia|sonyericsson|mini|windows\sce|palm/i.test(
...
!(function (e, t) {
  ...
  function o(e, r, i) {
    ...
    typeof r == "string" && ((i = r), (r = void 0)),
      ...
      i && (o = t(i));
    var u = "" + o.version;
    for (var a in e) if (e.hasOwnProperty(a) && o[a]) return s([u, e[a]]) < 0;
    return r;
  }
  function u(e, t, n) {
    return !o(e, t, n);
...
String.prototype.test = function (regex, params) {
  return (typeof regex == "string" ? new RegExp(regex, params) : regex).test(
    this
  );
};
...
String.prototype.replaceAll = function (FindString, ReplaceString) {
  ...
  while (this.indexOf(FindString, SearchIndex) != -1) {
    NewString += this.substring(
      SearchIndex,
      this.indexOf(FindString, SearchIndex)
    );
...
function jwxe_setMouseOverOut(obj, over_bg, out_bg) {
  ...
  obj.mouseleave(function () {
    ...
    var jqry = $(this),
      cls;
    if (
      (cls = jqry.parent().parent().attr("class")) &&
      cls.test(/jwxe_menu_box0|jwxe_menu_box2/) == false
    ) {
        ...
        if (obj.sson_out_bg) {
          ...
          if (obj.ssoff_sel_out_bg) {
            ...
            if (obj.ssoff_sel_over_bg) {
              ...
              jwxe_setMouseOverOut(
                el,
                obj.ssoff_sel_over_bg,
                obj.ssoff_sel_out_bg
              );
            }
          } else {
...
$(function () {
  ...
  if (lastIndex >= 0) curUrl = curUrl.substring(0, lastIndex);
  ...
  for (i = 0; i < _anchors.length; i++) {
    ...
    if (url) {
      ...
      if (lastIndex >= 0) url = url.substring(0, lastIndex);
    }
...
$(function () {
  ...
  vote_objs.css(
    "top",
    vote_objs.parent().parent().parent().height() - 39 + "px"
  );
  vote_objs.css(
    "left",
    vote_objs.parent().parent().parent().width() - 92 + "px"
  );

  var q_objs = $("div[class=jwxe_survey_q]");
  q_objs.css(
    "width",
    q_objs.parent().parent().parent().parent().width() - 50 + "px"
  );
...
var jwxe_zoomIn = function () {
  ...
  alert(
    "표준 브라우저에서의 확대/축소는 브라우저의 기능을 이용합니다.\n화면 확대: 키보드의 control키와 '+'를 동시에 누릅니다.\n화면 축소: 키보드의 control키와 '-'를 동시에 누릅니다."
  );
};
...
$(function () {
  ...
  var jwxe_zoomInFont = function () {
    ...
    $("body *").each(function () {
      ...
      if ($this.data("font-size")) {
        $this.css(
          "font-size",
          $this.data("font-size").toInt() + current_font_step + "px"
        );
      }
    });
  };
  ...
  if (obj.length > 0) {
    ...
    var str =
      "<form id='jwxe_print_form' action='" +
      rootPath +
      "/_common/template/print.jsp' method='post' target='_blank'>" +
...
$(function () {
  var _quickSideMenuBox = $(
    ".jwxe_quick_side_menu, .jwxe_quick_right_side_menu"
  );
  ...
  var _quickSideChange = function (firstLoading) {
    ...
    if (
      startsWith(
        _quickSideMenuBox.get(0).className,
        "jwxe_quick_right_side_menu"
      )
    ) {
    ...
    // 최소값의 적용
    if (left < jwxe_left_quick_min_x) left = jwxe_left_quick_min_x;

    if ($.browser.msie) {
      left -= 4;

      if ($.browser.version == 6.0 || el.scrollHeight > el.offsetHeight) {
        if ($.browser.version == 6.0) left -= 13;
        else left -= 17;
      }
    }
    _quickSideMenuBox.stop();
    _quickSideMenuBox.animate(
      { top: top, left: left - _quickSideMenuBoxWidth },
      400
    );
  };
...
function JwxeGoogleInitMap() {
  ...
  var contentString = '<div id="content">' + "<p>" + title + "</p>";
  ("</div>");
...
Date.prototype.getDateString = function (dateFormat) {
  ...
  dateFormat =
    (dateFormat == 8 && "YYYY.MM.DD") ||
    (dateFormat == 6 && "hh:mm:ss") ||
    dateFormat ||
    "YYYY.MM.DD hh:mm:ss";
  for (var i = 0; i < dateFormat.length; i++) {
    result +=
      dateFormat.indexOf("YYYY", i) == i
        ? ((i += 3), this.getFullYear())
        : dateFormat.indexOf("YY", i) == i
        ? ((i += 1), String(this.getFullYear()).substring(2))
        : dateFormat.indexOf("MMM", i) == i
        ? ((i += 2), Date.MONTHS[this.getMonth()])
        : dateFormat.indexOf("MM", i) == i
        ? ((i += 1), (this.getMonth() + 1).to2())
        : dateFormat.indexOf("M", i) == i
        ? this.getMonth() + 1
        : dateFormat.indexOf("DDD", i) == i
        ? ((i += 2), Date.DAYS[this.getDay()])
        : dateFormat.indexOf("DD", i) == i
        ? ((i += 1), this.getDate().to2())
        : dateFormat.indexOf("D", i) == i
        ? this.getDate()
        : dateFormat.indexOf("hh", i) == i
        ? ((i += 1), this.getHours().to2())
        : dateFormat.indexOf("h", i) == i
        ? this.getHours()
        : dateFormat.indexOf("mm", i) == i
        ? ((i += 1), this.getMinutes().to2())
        : dateFormat.indexOf("m", i) == i
        ? this.getMinutes()
        : dateFormat.indexOf("ss", i) == i
        ? ((i += 1), this.getSeconds().to2())
        : dateFormat.indexOf("s", i) == i
        ? this.getSeconds()
        : dateFormat.charAt(i);
  }
  return result;
...
if (typeof _edit_content != "undefined" && _edit_content) {
  ...
  var _showEditBtn = function (html, onlyMainYn, mainItemKey) {
    _editBtn_ = $(
      '<button class="jw-edit-btn" id="_jwxe_edit_content" >' +
        $m("편집") +
        "</button>"
    );

    _editBtnWrap = $(
      '<div class="jw-edit-btn-wrap" style="padding-top:50px;clear:both;text-align:right;position:relative;z-index:101">'
    ).append(_editBtn_);
    ...
    if (typeof _cfgUseDevMode != "undefined" && _cfgUseDevMode) {
      ...
      if (typeof developMode == "undefined") {
        // 개발모드로 전환 버튼
        var devBtn = $(
          '<a id="_jwxe_dev_mode" style="cursor:pointer;margin-left:10px;" ><img src="' +
            rootPath +
            '/_common/img/btn-dev.gif" alt=""/></a>'
        );
        ...
        modeNm = "개발";
        var realBtn = $(
          '<a id="_jwxe_real_mode" style="cursor:pointer;margin-left:10px;" ><img src="' +
            rootPath +
            '/_common/img/btn-real.gif" alt=""/></a>'
        );
        realBtn.click(function () {
          ...
          location.href =
            sysPath +
            "/proc/call_preview_page.jsp?url=" +
            encodeURIComponent(location.pathname);
        });
    ...
    _editBtn_.click(function (e) {
      ...
      var _cntItem = body.find(
        "Y" == onlyMainYn ? printSelector : '[class*="lo_"],[class*="cms-edit"]'
      );
      var wrapper = $("<div>" + html + "</div>");
      var tmpItem = wrapper.find(
        "Y" == onlyMainYn ? printSelector : '[class*="lo_"],[class*="cms-edit"]'
      );
      ...
      for (var i = 0; i < tmpItem.length; i++) {
        ...
        var href =
          ...
          _siteId +
          "&_edit=Y&_key=" +
          encodeURIComponent(tmp.attr("item")) +
          (typeof developMode != "undefined" && developMode == true
            ? "&developMode=Y"
            : "");

        var btn = $(
          '<a class="cms-edit-btn" title="' +
            $m("편집") +
            '" href="' +
            href +
            '" target="' +
            tmp.attr("item") +
            '"><img class="cms-edit-img" src="' +
            rootPath +
            '/_common/img/tick-button.png" alt="' +
            $m("편집") +
            '" /></a>'
        );
  ...
  $(function () {
    ...
    $.ajax({
      url:
        rootPath +
        "/_common/jsp/auth/check_edit_auth.jsp?dc=" +
        new Date().getTime(),
      data: {
        _key: _key,
      },
...
function _showPajetBtn() {
  _pajetBtn = $(
    '<button class="jw-edit-btn">' + $m("접근성검사") + "</button>"
  );
...
function recommend(obj, article_no, mode) {
  $.ajax({
    url:
      rootPath +
      "/_common/jsp/recommend/set_point.jsp?dc=" +
      new Date().getTime(),
    data: {
      mode: mode,
...
var youtubeGen = function () {
  $(".jwxe-youtube").each(function () {
    ...
    if (src) {
      var html =
        '<div class="b-video-box"><iframe title="유투브 동영상" align="center" src="https://www.youtube.com/embed/' +
        src +
...
Andwise.app.Validator = function ($form) {
  ...
  if ($form) {
    this.items = $form.find(
      'input[class*="jwvalid-"],select[class*="jwvalid-"],textarea[class*="jwvalid-"]'
    );
  } else {
    this.items = $(
      'input[class*="jwvalid-"],select[class*="jwvalid-"],textarea[class*="jwvalid-"]'
...
Andwise.app.Validator.prototype = {
  regex: {
    ...
    tel: {
      ...
      msg: function () {
        return (
          $m("형식오류", "형식에 맞지 않습니다.") +
          " ex) 02-123-1234 또는 010-123-1234"
        );
      },
      valid: function (val) {
        if (!val) return true;
    ...
    url: {
      ...
      msg: function () {
        return (
          $m("형식오류", "형식에 맞지 않습니다.") + " ex)http://www.abc.com"
        );
      },
      valid: function (val) {
        if (!val) return true;
        return /^((http(s?))\:\/\/)([0-9a-zA-Z\-]+\.)+[a-zA-Z]{2,6}(\:[0-9]+)?(\/\S*)?$/.test(
          val
        );
      },
    },
    ...
    pwd: {
      ...
      valid: function (val, len, $this) {
        ...
        if (retv && $this.parents("form").length > 0) {
          this.message =
            "휴대폰 또는 전화번호중 세자이상 동일한 숫자를 사용할 수 없습니다.";
      ...
      for (var i = 0; i < this.items.length; i++) {
        ...
        for (var j = 0; j < classes.length; j++) {
          ...
          if (index > -1) {
            ...
            var attrTitle = item.attr("data-valid-title"),
              step = 3;
            ...
            if (!this.regex[regexKey].valid(value, regVal, item)) {
              ...
              $("html,body")
                .stop(true, false)
                .animate({ scrollTop: t - 160 }, 900, function () {
                  item.focus();
                });
  ...
  getValidMessage: function (typeKey, regexKey) {
    ...
    if (toStr(locale, "ko") == "ko") {
      tail = this.isHanTail(this.title[typeKey])
        ? this.regex[regexKey].hanTail[0]
        : this.regex[regexKey].hanTail[1];
    }
...
$(function () {
  $('a[class*="jwzip-"],input[class*="jwzip-"]').click(function (e) {
    ...
    if (arr) {
      ...
      var autoHref =
        rootPath +
        "/_common/jsp/popup_zipcode_new.jsp?addr1=" +
        arr[1] +
        "&addr2=" +
        arr[2];
      if (arr.length > 4) {
...
$(function () {
  $('a[class*="jwnewzip-"],input[class*="jwnewzip-"]').click(function (e) {
    ...
    if (arr) {
      ...
      var autoHref =
        rootPath +
        "/_common/jsp/new_zipcode/road.jsp?addr1=" +
        arr[1] +
        "&addr2=" +
        arr[2];
      if (arr.length > 4) {
...
$(function () {
  $('a[class*="jwnewjuso-"],input[class*="jwnewjuso-"]').click(function (e) {
    ...
    if (arr) {
      ...
      var autoHref =
        rootPath +
        "/_common/jsp/new_juso/jusoPopup.jsp?addr1=" +
        arr[1] +
        "&addr2=" +
        arr[2];
      if (arr.length > 4) {
...
function loadFacyBoxScript() {
  ...
  loadJavascript(
    rootPath + "/_common/js/fancybox/jquery.fancybox-1.3.4.pack.js"
  );
}
...
$(function () {
  $('form[action="' + rootPath + '/_common/jsp/redirect.jsp"]').submit(
    function () {
      if (!this.link.value) {
...
$(function () {
  ...
  if ($("#pdfDown").length > 0) {
    var form = $(
      '<form method="post" name="pdfForm" action="' +
        ctx +
        '/cms/plugin/pdf/pdfOpen.do" target="_blank">' +
...
function initEditor(option) {
  ...
  if (
    editorVendor == "froala" &&
    bowser.msie &&
    parseInt(bowser.version) < 10
  ) {
    editorVendor = "daumEditor";
  } else if (
    editorVendor == "ckeditor3" &&
    bowser.msie &&
    parseInt(bowser.version) > 9
  ) {
    editorVendor = "daumEditor";
  }
  ...
  return {
    ...
    innoditor: function () {
      ...
      return {
        ...
        init: function (option) {
          var height = option.height || EditorAdaptor.defaultHeight,
            index = option.index,
          ...
          var html =
            ...
            'g_arrSetEditorArea[0] = "innoditor' +
            index +
            '";\n' + // 이노디터를 위치시킬 영역의 ID값 설정
            "</script>\n" +
            '<script src="' +
            ctx +
            '/_common/js/jquery/jquery-1.9.1.js" type="text/javascript"></script>\n' +
            '<script language="javascript" src="' +
            ctx +
            '/_common/_plugin/innoditor/js/customize.js" type="text/javascript"></script>\n' +
            '<script language="javascript" src="' +
            ctx +
            '/_common/_plugin/innoditor/js/customize_ui.js" type="text/javascript"></script>\n' +
            '<script language="javascript" src="' +
            ctx +
            '/_common/_plugin/innoditor/js/loadlayer.js" type="text/javascript"></script>\n';

          for (var i = 0; i < css.length; i++) {
            html +=
              '<link remove="y" rel="stylesheet" href="' +
              css[i] +
              '"type="text/css">';
          }
          ...
          html +=
            '<script language="javascript" type="text/javascript">\n' +
            "function setValue() {\n" +
            "fnSetEditorHTMLCode( parent.EditorAdaptor.getTextValue(" +
            index +
            " ),false, 0 )\n" +
            "}\n" +
            "function getValue() {\n" +
            "var text = fnGetEditorHTMLCode(false," +
            index +
            ");\n" +
            'if (text == "<p><br></p>"){\n' +
            ' text = ""\n' +
    ...
    daumEditor: function () {
      ...
      return {
        ...
        init: function (option) {
          var template,
            height = option.height || EditorAdaptor.defaultHeight,
            index = option.index,
            $textarea = option.$textarea;
          ...
          $.ajax({
            ...
            success: function (response) {
              ...
              template = template.replace(
                /\$\{isImageFullUrl\}/g,
                typeof option.isImageFullUrl == "undefined"
                  ? "false"
                  : option.isImageFullUrl
                  ? "true"
                  : "false"
              );
            },
      ...
      return {
        ...
        init: function (option) {
          var template,
            ...
            extCss = "";
          (locale = typeof locale == "undefined" ? "ko" : locale),
            (bodyCls = option.bodyCls || "board-view-txt");
    ...
    ckeditor3: function () {
      ...
      return {
        getData: function () {
          return $iframe[0].contentWindow.CKEDITOR.instances[
            "textarea"
          ].getData();
        },
        ...
        init: function (option) {
          ...
          var source = [
            ...
            '<script type="text/javascript" src="' +
              ctx +
              '/_common/js/jquery/jquery-1.9.1.js"></script>',
            '<script type="text/javascript" src="' +
              ctx +
              '/_common/_plugin/namo_editor3/js/namo_scripteditor.js" ></script>',
            "</head>",
            '<body style="padding:0;margin:0">',
            ...
            'parent.$("#namoIframe' +
              index +
              '").css("height",$(document.body).height()+20);',
            "e.editorTarget.SetBodyValue( parent.EditorAdaptor.getTextValue(" +
              index +
              ") );",
            "document.close();",
            "}",
